...
<title>Bulwark Security Report{{if .Meta.Target}} — {{.Meta.Target}}{{end}}</title>
<style>
...
<div class="wrap">
  ...
  <footer>
    Generated by Bulwark. Findings are assistive evidence — validate before acting. Remediation guidance is suggested, never executed automatically.
  </footer>
</div>
</body>
</html>
